...
const copy = {
  en: {
    ...
    demoTitle: "Closing simulation", demoWarning: "SIMULATION ONLY — no payment instructions, held funds, transfer, refund, or payout. RealEstate does not hold your money.", demoIntro: "After staff review, you can rehearse the closing steps with fake money events.",
    demoStart: "Start simulated closing", demoReference: "Demo reference", demoSellerNet: "Illustrative seller proceeds", demoFund: "Simulate successful payment", demoFail: "Simulate failed payment", demoRequestRelease: "Request simulated release", demoRequestRefund: "Request simulated refund", demoApprove: "Approve simulated outcome", demoBalanced: "Demo ledger reconciled", demoUnbalanced: "Demo ledger needs review", demoSecondReviewer: "A release or refund needs two distinct authorized managers. Open disputes pause approval.",
    demo_awaiting_demo_payment: "Awaiting simulated payment", demo_payment_failed: "Simulated payment failed", demo_demo_held: "Simulated funds held", demo_release_pending: "Simulated release awaiting approval", demo_refund_pending: "Simulated refund awaiting approval", demo_demo_released: "Simulated release complete", demo_demo_refunded: "Simulated refund complete",
    ...
    authorityBlockedTitle: "This offer needs seller verification", authorityBlockedSeller: "Upload proof that you own the property or may sell it. A sales reviewer must approve it before either party can send a protected offer.", authorityBlockedBuyer: "Ask the seller in this chat to submit proof of authority. You can retry the offer after a sales reviewer approves it. Do not send money in chat.", authoritySteps: "Seller: submit authority evidence", authorityReviewStep: "The file is private. Its status will show as pending, approved, or rejected here. If rejected, read the review note and upload corrected evidence.",
  ...
  ar: {
    ...
    demoTitle: "محاكاة إتمام البيع", demoWarning: "محاكاة فقط — لا توجد تعليمات دفع أو أموال محفوظة أو تحويل أو استرداد أو صرف. الموقع لا يحتفظ بأموالك.", demoIntro: "بعد مراجعة الفريق، يمكنك تجربة خطوات الإغلاق بأحداث مالية وهمية.",
    demoStart: "ابدأ محاكاة الإغلاق", demoReference: "مرجع تجريبي", demoSellerNet: "صافي البائع التوضيحي", demoFund: "حاكِ نجاح الدفع", demoFail: "حاكِ فشل الدفع", demoRequestRelease: "اطلب صرفاً تجريبياً", demoRequestRefund: "اطلب استرداداً تجريبياً", demoApprove: "اعتمد النتيجة التجريبية", demoBalanced: "السجل التجريبي متوازن", demoUnbalanced: "السجل التجريبي يحتاج مراجعة", demoSecondReviewer: "يتطلب الصرف أو الاسترداد اعتماد مديرين مختلفين. يوقف النزاع المفتوح الاعتماد.",
    demo_awaiting_demo_payment: "بانتظار دفع تجريبي", demo_payment_failed: "فشل الدفع التجريبي", demo_demo_held: "أموال تجريبية محفوظة", demo_release_pending: "صرف تجريبي ينتظر الاعتماد", demo_refund_pending: "استرداد تجريبي ينتظر الاعتماد", demo_demo_released: "اكتمل الصرف التجريبي", demo_demo_refunded: "اكتمل الاسترداد التجريبي",
    ...
    authorityBlockedTitle: "يحتاج هذا العرض إلى التحقق من صلاحية البائع", authorityBlockedSeller: "ارفع إثبات ملكية العقار أو تفويض البيع. يجب أن يعتمده مراجع المبيعات قبل تقديم عرض بيع محمي.", authorityBlockedBuyer: "اطلب من البائع في هذه المحادثة رفع إثبات الصلاحية. يمكنك إعادة محاولة العرض بعد اعتماده. لا ترسل أموالاً عبر المحادثة.", authoritySteps: "للبائع: ارفع إثبات الصلاحية", authorityReviewStep: "الملف خاص. ستظهر حالته هنا: قيد المراجعة أو معتمد أو مرفوض. إذا رُفض، اقرأ ملاحظة المراجع وارفع إثباتاً مصححاً.",
