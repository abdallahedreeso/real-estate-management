...
const copy = {
  en: {
    ...
    authorityHint: "Sale listings remain private until authority evidence is reviewed.", refresh: "Confirm still available", archive: "Archive", archived: "Archived",
  ...
  ar: {
    ...
    authorityHint: "يبقى إعلان البيع خاصاً حتى مراجعة إثبات صلاحية البائع.", refresh: "أكد استمرار الإتاحة", archive: "أرشف", archived: "مؤرشف",
